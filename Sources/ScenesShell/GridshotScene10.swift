...
class GridshotScene10 : Scene {
    ...
    let gridshotInteractionLayer10 = GridshotInteractionLayer10()
        
    init() {
        // Using a meaningful name can be helpful for debugging
        super.init(name:"Gridshot Scene")
        ...
        insert(layer:gridshotInteractionLayer10, at:.inFrontOf(object:backgroundLayer))
    }
}
