...
class TrackshotScene : Scene {
    ...
    let trackshotInteractionLayer = TrackshotInteractionLayer()
        
    init() {
        // Using a meaningful name can be helpful for debugging
        super.init(name:"Trackshot Scene")
        ...
        insert(layer:trackshotInteractionLayer, at:.inFrontOf(object:backgroundLayer))
    }
}
