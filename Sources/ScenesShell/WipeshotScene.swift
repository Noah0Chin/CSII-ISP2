...
class WipeshotScene : Scene {
    ...
    let wipeshotInteractionLayer = WipeshotInteractionLayer()
        
    init() {
        // Using a meaningful name can be helpful for debugging
        super.init(name:"Wipeshot Scene")
        ...
        insert(layer:wipeshotInteractionLayer, at:.inFrontOf(object:backgroundLayer))
    }
}
